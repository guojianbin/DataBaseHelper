...
#pragma warning disable 1066, 1570, 1573, 1591
	...
	/// <summary>
	/// 主要PetaPoco数据库类。你可以直接使用这个类,或来源于它。
	/// </summary>
	public class Database : IDisposable, IDatabase
	{
		...
		/// <summary>
		///     构造一个实例使用所提供的连接字符串,并选择一个提供者的名字。如果没有提供者名称,默认的数据库提供商将MS SQL Server。
		/// </summary>
		...
		/// <summary>
		///     构造一个实例使用提供的连接字符串和DbProviderFactory。
		/// </summary>
		/// <param name="connectionString">The database connection string.</param>
		...
		/// <summary>
		///     提供连接字符串构造一个实例使用一个名称。实际的连接字符串和提供者将从应用程序读取/ web.config。
		/// </summary>
		...
		/// <summary>
		///     构造一个实例使用提供的<paramref name="configuration"/>.
		/// </summary>
		...
		/// <summary>
		///     时调用一个事务开始。被T4模板生成的数据库类,以确保在整个交易中使用相同的数据库实例。
		/// </summary>
		...
		/// <summary>
		///     保存少通过执行一个SQL Insert或SQL Update
		/// </summary>
		...
		/// <summary>
		///     当设置为true,PetaPoco将自动创建的“选择列”部分看起来需要它的任何查询
		/// </summary>
		public bool EnableAutoSelect { get; set; }

		/// <summary>
		///     当设置为true时,参数可以命名? myparam和填充属性传递的参数值。
		/// </summary>
		...
		/// <summary>
		///     得到了加载数据库提供商. <seealso cref="Provider" />.
		/// </summary>
		/// <returns>
		///     加载数据库类型。
		/// </returns>
